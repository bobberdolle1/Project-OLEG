...
### � Разлишчение пользователей в групповых чатах
...
### �️ Уплучшенная защита от prompt injection
...
- `app/services/ollama_client.py` — примеры в промпте, защита от injection
