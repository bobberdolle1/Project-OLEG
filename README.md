...
### � Mini Gamses & Economy — Главные фичи

```diff
+ � Рaыбалка (/fish) — лови рыбу разной редкости и продавай!
...
+ � Войгна (/war) — карточная игра, у кого старше
+ 🎡 Колесо фортуны (/wheel) — крути и выигрывай до x10!
+ 📦 Лутбоксы (/loot) — открывай коробки за монеты
+ � Петушинsые бои (/cockfight) — выбери петуха и ставь!
+ 🏪 Магазин (/shop) — покупай предметы за монеты
+ � ЭконоTмика — баланс, ежедневный бонус, переводы
+ � Game лHub 3 страницы — все игры с пагинацией
```
