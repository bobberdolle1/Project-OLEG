...
RANKS = [
    ...
    (305, "Три ноль пять хуя"),
    (310, "Слоновий хуище"),
    (315, "Три пятнадцать"),
    (320, "Три двадцать хуя"),
    (325, "Три двадцать пять"),
    (330, "Жирафий хуй"),
    (335, "Три тридцать пять"),
    (340, "Три сорок члена"),
    (345, "Три сорок пять"),
    (350, "Три пятьдесят хуища"),
    (355, "Три пятьдесят пять"),
    (360, "Полный оборот хуя"),
    (365, "Год хуя"),
    (370, "Три семьдесят"),
    (375, "Три семьдесят пять"),
    (380, "Три восемьдесят"),
    (385, "Три восемьдесят пять"),
    (390, "Почти четыре метра"),
    (395, "Три девяносто пять"),
    (400, "🚀 ЧЕТЫРЕ МЕТРА ХУИЩА 🚀"),

    # === ПЛАНЕТАРНЫЕ ЧЛЕНЫ (401-500 см) ===
    (405, "Хуй-четыре ноль пять"),
    (410, "Тираннозавровый хуй"),
    (415, "Член-юрского периода"),
    (420, "🌿 BLAZE IT ХУЙ 🌿"),
    (425, "Хуй-четыре двадцать пять"),
    (430, "Член-динозавр"),
    (435, "Хуй-мезозой"),
    (440, "Член-птеродактиль"),
    (445, "Хуй-четыре сорок пять"),
    (450, "Член-полпятого метра"),
    (455, "Хуй-четыре пятьдесят пять"),
    (460, "Член-метеорит"),
    (465, "Хуй-четыре шестьдесят пять"),
    (470, "Член-астероид"),
    (475, "Хуй-четыре семьдесят пять"),
    (480, "Член-комета"),
    (485, "Хуй-четыре восемьдесят пять"),
    ...
    (640, "Шесть сорок"),
    (650, "Шесть пятьдесят"),
    (660, "Шесть шестьдесят"),
    (666, "😈 ДЬЯВОЛЬСКИЙ ХУЙ 😈"),
    (670, "Шесть семьдесят"),
    (680, "Шесть восемьдесят"),
    (690, "🔥 НАЙС ×10 ХУЙ 🔥"),
    ...
    (860, "Восемь шестьдесят"),
    (870, "Восемь семьдесят"),
    (880, "Хуй-восьмибитка"),
    (888, "Тройная восьмёрка хуя"),
    (890, "Хуй-турбо"),
    (900, "ДЕВЯТЬ МЕТРОВ ЧЛЕНА"),
    (910, "Член-спринтер"),
    (911, "Экстренный хуй"),
    (920, "Хуй-радиостанция"),
    (930, "Член-ретро"),
    (940, "Хуй-форсаж"),
    (950, "Член-полукилометр"),
    (960, "Хуй-мегабайт"),
    (970, "Член-легенда"),
    (980, "Хуй-турбонаддув"),
    (990, "Член-финишная прямая"),
    (999, "Один до тысячи хуя"),
    (1000, "🔥🔥🔥 ТЫСЯЧА СМ ХУИЩА 🔥🔥🔥"),

    # === ВСЕЛЕНСКИЕ ХУИ (1001-2000 см) ===
    (1100, "Хуй-километр с хвостиком"),
    (1200, "Член-дюжина метров"),
    (1234, "Раз-два-три-четыре хуя"),
    (1300, "Хуй-чёртова дюжина метров"),
    (1337, "L33T ХУЙ H4X0R"),
    (1400, "Член-полтора километра почти"),
    (1488, "Тот самый хуй"),
    (1500, "Полторы тысячи хуища"),
    (1600, "Хуй-шестнадцать метров"),
    (1700, "Член-семнадцать метров"),
    (1800, "Хуй-восемнадцать метров"),
    (1900, "Член-девятнадцать метров"),
    ...
    (2600, "Олимпийский хуй"),
    (2700, "Член Леонидаса"),
    (2800, "Хуй-небоскрёб"),
    (2900, "Почти три тысячи хуища"),
    (3000, "ТРИ ТЫСЯЧИ ХУИЩА"),
    (3100, "Хуй-башня"),
    (3200, "Член Эйфелевой башни"),
    (3300, "Хуй-антенна"),
    (3333, "Тройной хуй"),
    (3400, "Член-небоскрёб"),
    ...
    (4600, "Член-орбита"),
    (4700, "Хуй до луны"),
    (4800, "Космический член"),
    (4900, "Почти пять тысяч хуища"),
...
async def cmd_grow(msg: Message):
    ...
    async with async_session() as session:
        ...
        reply_text = f"Текущий: {gs.size_cm} см\n"
        
        if failure_msg:
            reply_text = f"{failure_msg}\n\n" + reply_text
            if gain < 0:
                reply_text = reply_text.replace("Текущий:", f"{gain} см 💀\nТекущий:")
        else:
