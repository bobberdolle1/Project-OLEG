...
RANKS = [
    ...
    (405, "Четыре ноль пять"),
    (410, "Тираннозавровый хуй"),
    (415, "Четыре пятнадцать"),
    (420, "🌿 BLAZE IT ХУЙ 🌿"),
    (425, "Четыре двадцать пять"),
    (430, "Четыре тридцать"),
    (435, "Четыре тридцать пять"),
    (440, "Четыре сорок хуя"),
    (445, "Четыре сорок пять"),
    (450, "Четыре пятьдесят"),
    (455, "Четыре пятьдесят пять"),
    (460, "Четыре шестьдесят"),
    (465, "Четыре шестьдесят пять"),
    (470, "Четыре семьдесят"),
    (475, "Четыре семьдесят пять"),
    (480, "Четыре восемьдесят"),
    (485, "Четыре восемьдесят пять"),
    (490, "Почти полтысячи хуя"),
    (495, "Четыре девяносто пять"),
    (500, "💎 ПОЛТЫСЯЧИ ХУИЩА 💎"),
