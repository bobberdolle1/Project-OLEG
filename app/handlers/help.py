...
/top — Топ-10 игроков по размеру
/top_rep — Топ-10 по репутации
/profile — Твой профиль со статистикой
/pvp @username — Дуэль с другим игроком
/casino [ставка] — Слоты (по умолчанию 10 монет)

💡 <i>Новичок? Напиши /games или спроси "помоги с играми"!</i>

<b>Гильдии:</b>
/create_guild [название] — Создать гильдию
/join_guild [название] — Вступить в гильдию
/leave_guild — Покинуть гильдию
/guild_info — Информация о твоей гильдии
/guild_war @гильдия [часы] — Объявить войну

<b>Дуэты:</b>
/create_duo @партнер — Создать дуэт
/duo_stats — Статистика дуэта
/duo_pvp @дуэт — Дуэль дуэтов

<b>Достижения и квесты:</b>
/achievements — Список всех достижений
/my_achievements — Твои достижения
...
/strikes — Посмотреть предупреждения
...
/owner — <b>Панель владельца бота</b> (только для OWNER_ID)
