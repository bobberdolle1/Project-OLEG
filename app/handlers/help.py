...
/join_guild [имя] — Вступить
/guild_info — Информация о гильдии

<b>👥 Дуэты:</b>
/create_duo @партнер — Создать дуэт
...
/советы или /tips — Советы по управлению чатом
...
<b>Сохранение:</b>
/q — Сохранить цитату (реплай на сообщение)
/qs [тег] — Сохранить с тегом

<b>Просмотр:</b>
/q [тег] — Случайная цитата по тегу
/q @user — Цитаты пользователя

<b>Удаление:</b>
/qd [id] — Удалить цитату (только автор/админ)
